...
function TraineeSignInPage() {
  ...
  const handleSubmit = (event) => {
    ...
    if (!hasErrors) {
      ...
      window.location.href = "/homepage"; // Navigate to the next page
    }
  };

  return (
    <center>
      <div className="trainee-sign-in-page" style={{ backgroundColor: "white" }}>
        {" "}
        <br></br>
        <br></br>
        <h1>Sign in as Trainee</h1>
...
export default TraineeSignInPage;
